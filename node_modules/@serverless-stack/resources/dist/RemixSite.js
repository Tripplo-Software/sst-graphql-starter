...
export class RemixSite extends Construct {
    ...
    createServerFunctionRoleForRegional() {
        return this.createServerFunctionRole([
            "lambda.amazonaws.com",
        ]);
    }
    createServerFunctionRoleForEdge() {
        return this.createServerFunctionRole([
            "lambda.amazonaws.com",
            "edgelambda.amazonaws.com",
        ]);
    }
    createServerFunctionRole(principals) {
        const { defaults } = this.props;
        // Create function role
        const role = new iam.Role(this, `ServerLambdaRole`, {
            assumedBy: new iam.CompositePrincipal(...principals.map((principal) => new iam.ServicePrincipal(principal))),
            managedPolicies: [
    ...
    createServerFunctionInUE1(name, asset, assetPath) {
        const { defaults } = this.props;
        // Create function
    ...
    createServerFunctionInNonUE1(name, asset, _assetPath) {
        const { defaults } = this.props;
        ...
        const functionCR = crossRegionHelper.createFunction(this, name, this.serverLambdaRole, bucketName, {
            Description: `${name} handler for Remix`,
            Handler: "server.handler",
            Code: {
