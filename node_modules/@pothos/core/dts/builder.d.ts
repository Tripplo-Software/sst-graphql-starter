...
export default class SchemaBuilder<Types extends SchemaTypes> {
    ...
    interfaceType<Param extends InterfaceParam<Types>, Interfaces extends InterfaceParam<Types>[]>(param: Param, options: InterfaceTypeOptions<Types, Param, ParentShape<Types, Param>, Interfaces>, fields?: InterfaceFieldsShape<Types, ParentShape<Types, Param>>): InterfaceRef<AbstractReturnShape<Types, Param>, ParentShape<Types, Param>>;
    ...
    unionType<Member extends ObjectParam<Types>>(name: string, options: PothosSchemaTypes.UnionTypeOptions<Types, Member>): UnionRef<AbstractReturnShape<Types, Member>, ParentShape<Types, Member>>;
